public class TestStringBuilder {
    public static void main(String[] args) {
      ...
      //  s1 = s1+ " BMW";
        ...
        sb1.append(" BMW"); // tot ze rezultat, chto i viwe, tolko logika pamjati drugaja
        System.out.println(sb1);
        sb1.append(" m5");
        System.out.println(sb1);
        sb1.append(" 25");
        ...
        System.out.println("capacity = "+sb1.length());
        ...
        System.out.println("capacity = "+sBuf.length());

        sBuf.insert(5, "BF ");//dobavitj posle Auto i Wolkswagen slovo BF
        System.out.println(sBuf);
